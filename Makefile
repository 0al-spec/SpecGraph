...
PRODUCT_WORKSPACE_INTAKE_SOURCE ?= tests/fixtures/team_decision_log/idea_event_storming_seed.json
PRODUCT_WORKSPACE_CANDIDATE_SEED ?= tests/fixtures/team_decision_log/candidate_spec_graph_seed.json
