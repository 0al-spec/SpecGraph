...
USER_IDEA_INTAKE_INTERVIEW_IDEA_TEXT ?=
...
USER_IDEA_INTAKE_INTERVIEW_IDEA_TEXT_ARG := $(if $(strip $(USER_IDEA_INTAKE_INTERVIEW_IDEA_TEXT)),--idea-text "$(USER_IDEA_INTAKE_INTERVIEW_IDEA_TEXT)",)
...
help:
	@printf '%s\n' \
		...
		'  make external-handoffs        Refresh external consumer handoff JSON' \
			...
			'  make real-idea-intake USER_IDEA_INTAKE_INTERVIEW_IDEA_TEXT=<text>' \
