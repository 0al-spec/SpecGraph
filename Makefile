...
product_workspace_repaired_baseline_input = $(if $(filter file,$(origin $(1))),$(product_workspace_repaired_output_dir)/$(2),$($(1)))
...
ifeq ($(PRODUCT_WORKSPACE_CANDIDATE_SEED_MODE),generate)
	...
	@$(MAKE) idea-to-spec-initial-repair-session-journal \
		...
		IDEA_TO_SPEC_REPAIR_SESSION_PROMOTION_GATE_FROM_ACTIVE_CANDIDATE=1 \
...
product-workspace-repaired-promotion-handoff:
	...
	@$(MAKE) product-workspace-idea-maturity \
		...
		IDEA_MATURITY_METRICS_CANDIDATE_GRAPH="$(call product_workspace_repaired_baseline_input,IDEA_MATURITY_METRICS_CANDIDATE_GRAPH,candidate_spec_graph.json)" \
		IDEA_MATURITY_METRICS_PRE_SIB="$(call product_workspace_repaired_baseline_input,IDEA_MATURITY_METRICS_PRE_SIB,pre_sib_coherence_report.json)" \
		...
		IDEA_MATURITY_METRICS_PROMOTION_GATE="$(call product_workspace_repaired_baseline_input,IDEA_MATURITY_METRICS_PROMOTION_GATE,idea_to_spec_promotion_gate.json)" \
		IDEA_MATURITY_METRICS_REPAIR_SESSION="$(call product_workspace_repaired_baseline_input,IDEA_MATURITY_METRICS_REPAIR_SESSION,idea_to_spec_repair_session.json)" \
