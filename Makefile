...
PRODUCT_WORKSPACE_ACTIVE_CANDIDATE_REFRESH_AUTO := $(if $(findstring command line,$(origin ACTIVE_IDEA_TO_SPEC_CANDIDATE_CONFIG)),force,$(if $(findstring environment,$(origin ACTIVE_IDEA_TO_SPEC_CANDIDATE_CONFIG)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_IDEA_SOURCE)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_IDEA_SOURCE)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_INTAKE_SOURCE)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_INTAKE_SOURCE)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED_INPUT)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED_INPUT)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED_OUTPUT)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_CANDIDATE_SEED_OUTPUT)),force,$(if $(findstring command line,$(origin PRODUCT_WORKSPACE_ACTIVE_CANDIDATE_CONFIG)),force,$(if $(findstring environment,$(origin PRODUCT_WORKSPACE_ACTIVE_CANDIDATE_CONFIG)),force,auto))))))))))))))
