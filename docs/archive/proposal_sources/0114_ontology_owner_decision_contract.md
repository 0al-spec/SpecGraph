...
decision actor/time, accepted/rejected state, and explicit false SpecGraph
import, gate-close, and canonical mutation flags.
...
- Validate accepted/rejected/clarification states and reject import authority.
