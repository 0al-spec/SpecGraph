...
the canonical DocC entrypoint at
`https://0al-spec.github.io/SpecGraph/documentation/SpecGraph/`, the public
artifact manifest, generated runs, and the custom landing page. Do not deploy
